...
mycol_14 <- clr_desaturate(shift = 0.2, c(brewer.pal(9, 'Set1')[-6], brewer.pal(8, 'Set2')[c(1:3, 5:7)], 'grey20'))
mycol_60 <- clr_desaturate(shift = 0.1,
                           c(
                                   ...
                                   colorRampPalette(c("#2ba32b", 'white'))(8)[1:6],
...
mycol_40 <- clr_desaturate(shift = 0.1,
                           c(
                                   ...
                                   colorRampPalette(c("#2ba32b", 'white'))(6)[1:4],
...
mycol_30 <- clr_desaturate(shift = 0.1,
                           c(
                                   ...
                                   colorRampPalette(c("#2ba32b", 'white'))(7)[c(1,3,5)],
...
ConvertGeneID <- function(genes, species, from = 'id', to = 'symbol') {
        if (species == 'human') {
                ...
                if(from == 'id' & to == 'symbol'){
                        output <- ensembldb::select(EnsDb.Hsapiens.v79,
                                                    keys= genes,
                                                    keytype = "GENEID",
